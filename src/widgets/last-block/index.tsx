    ...
    <div className={'w-full sm:p-10 p-2 flex relative flex-col gap-3'}>
      ...
      <InfoTab>
        <div className={'flex flex-col text-white p-4 sm:p-8 gap-4'}>
          <div className={'whitespace-pre sm:text-xl text-sm font-extrabold'}>
            {title}
          </div>
          <div
            className={
            ...
            <AlertIcon className={'sm:w-10 w-2'} />
            <div className={'sm:text-base w-full text-xs'}>{description}</div>
          </div>
